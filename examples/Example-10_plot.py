#------------------------------------------------------------------
# Программа для создания анимации решения двумерного 
# дифференциального уравнения в частных производных 
# параболического типа, найденного в примере 10.1.
#
# Пример запуска программы:
#    python Example-10_plot.py Example-10-1_Results_all.npz
# где "Example-10-1_Results_all.npz" - это имя файла с данными
...
# (в примере выше будет создан файл "Example-10-1_Results_all.mp4").
#
...
parser = argparse.ArgumentParser(
            prog='python Example-10_plot.py',
...
# Диапазон изменений значений по осям `x` и `y`:
...
for m in range(0, len(u), frame_step):
    ...
    ax.pcolor(X, Y, u[m, :, :].T, shading='auto')
    ax.text(1.2, -1.7, f't = {t[m]:.3f}')
