# -----------------------------------------------------------------------------
# Реализация алгоритма параллельной быстрой сортировки -
# а конкретнее, так называемого "Hyper Quick Sort", основанного
# на параллельной сортировке в гиперкубе из P = 2^K процессов,
# где `K` - целое число.
#
# Данный алгоритм является прямой конвертацией на Python 
# реализации алгоритма, написанной на C++:
# https://github.com/nelsonfilipecosta/Parallel-Hyperquicksort/
# в файле "hyperquicksort.cpp".
#
# Смотри также описание алгоритма на страницах:
...
# -----------------------------------------------------------------------------
# NOTE:
# Пока что работа алгоритма неустойчива - появляются ошибки при
# попытке сортировки малых векторов с размерами N=64 или 128 на
# P=8 процессах. Также алгоритм просто зависает для больших
# значений N типа N = 1000*1024 на P=8 процессах. 
# Нужно искать баги...
# -----------------------------------------------------------------------------
