...
if __name__ == '__main__':
    ...
    mpi_timer.start('Step 1: set N, M')

    if rank == 0:
        M = np.array(1_000_000, dtype=np.int32)
        N = np.array(200, dtype=np.int32)
        # M = np.array(4096, dtype=np.int32)
        # N = np.array(4096, dtype=np.int32)
    else:
