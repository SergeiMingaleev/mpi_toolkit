...
# mpi_toolkit/examples/Example-05-1.py
# ------------------------------------------------------------------
...
# =============================================================================
class SolverParallelBlock1(SolverBase):
    """
    ...
    def _cgm_mpi_part(self, A_part, b_part, x_part,
        ...
        procs_first_row = np.arange(self._num_col)
        # и список процессов из первого столбца сетки процессов:
        procs_first_col = np.arange(0, self._P, self._num_col)
    ...
    def _conjugate_gradient_method(self, A, b, x):
        ...
        # процессах `b` is None.
        # Разбросаем его по всем процессам
